...
| `QUOTA_EXECUTE_CONCURRENCY` | `20` | Open (non-terminal) executions per workspace. Manual start, webhook ingress, and schedule dispatch share this cap. `0` or invalid uses 20. Negative disables the cap. |
