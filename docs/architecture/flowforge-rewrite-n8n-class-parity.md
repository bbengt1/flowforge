...
| **NDV / inspector** | Right rail, remembered-open satellite (R2.2 / #235): type-specific parameters / `with` for cataloged core / Kubernetes / SSH / script / HTTP (R3.1 / #246 — keep #246 open); pins / display-name credentials; workflow tabs Triggers / Versions / Pins; redacted last-run I/O | Typed field-path mapping depth (R3.2 / #247). No expression language. No `SecretField` in the rail. No branded NDV modal. |
