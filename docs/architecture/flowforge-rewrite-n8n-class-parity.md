...
4. **Embed** — R7.1 (#276 — **keep #276 open**) mounts R2–R6 rewrite chrome on the existing `/embed/v1` tree with `session.embed`. No Portal-specific cookie. No host-query authz. No second tree.
