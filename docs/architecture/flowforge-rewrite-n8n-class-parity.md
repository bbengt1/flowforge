...
| **Vault** | `/credentials/*` workbench find by display name (R5.1 / #264 — **keep #264 open**); NDV add reuses masked wizard | Test/rotate/usage densify (R5.2 / #265). Finish return-to-editor as the default (R5.3 / #266). Usage/deletion-impact without a secret surface. |
