...
| **Activations** | Editor top bar + Triggers tab compose “this published version is active” from enable + version pin (R6.1 / #270 — **keep #270 open**). Home drawers still work. Drafts never look live. | Home activation column (R6.2). One-gesture test-run (R6.3). No new activation resource. |
