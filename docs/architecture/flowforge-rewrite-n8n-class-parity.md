...
| **Activations** | Editor top bar + Triggers tab (R6.1 / #270 — **keep #270 open**) and `/workflows` home column (R6.2 / #271 — **keep #271 open**) compose “this published version is active” from enable + version pin. Home drawers still work. Drafts never look live. One-gesture **Test run** (R6.3 / #272 — **keep #272 open**) mints a published test version then starts it (D5). | No new activation resource. Drafts still never run. |
