...
3. **Foundation copy** — Settings keeps session/health/OpenAPI + disclosed Developer samples. R7.2 (#277 — **keep #277 open**) takes membership/isolation off product chrome: Settings may link carefully; they stay ADV-024 grant-gated; isolation success is a denial. Example context stays labeled and local-only.
