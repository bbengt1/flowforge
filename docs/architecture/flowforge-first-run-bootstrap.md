...
Status: **B.1–B.8 landed** (this page is the contract map). Product hard lines are unchanged: standalone wizard only, no secrets in responses, ADV-021 / ADV-024, drafts never run.
...
### B.8 non-prod defaults + TLS→https toast (landed)
