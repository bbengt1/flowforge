...
| Inspector rail + last-run panel (pre-R2.2) | Remembered-open conversation shell + persistent satellite (type-specific parameters / `with` / pins / credential display-name + redacted I/O + validation/policy; R3.1 / #246 — **keep #246 open**; R3.3 / #248 — **keep #248 open**) | A branded NDV, expression editor, or SecretField rail. |
