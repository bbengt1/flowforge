...
| Inspector rail + last-run panel (pre-R2.2) | Remembered-open conversation shell + persistent satellite (type-specific parameters / `with` / pins / credential display-name + redacted I/O; R3.1 / #246 — **keep #246 open**) | A branded NDV, expression editor, or SecretField rail. |
