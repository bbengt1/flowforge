...
- Empty home (UXL.6 / #293 — **keep #293 open**): Create, Import YAML, or pick a reviewed template — each creates a **draft**. Copy says drafts do not run. No starter/invalid YAML as primary buttons. Developer samples stay under Settings.
