...
| Membership / Isolation | `/membership`, `/isolation` | R7.2 (#277 / Part of #233 — **keep #277 open**): off product chrome. ADV-024 grant only. Settings may link carefully. Isolation success is a denial. Meaning of the grant is unchanged. |
