# E12.1 UI and embed evidence

Browser surfaces that can disagree with the API (iframe exchange, session chrome, approval decide). The harness and CI remain the API and engine authority. Map: [e12-security-verification.md](../e12-security-verification.md) § Operator UI map.
...
# or only the UI evidence checklist:
