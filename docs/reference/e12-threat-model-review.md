...
Confirm each row still matches [security-model.md](security-model.md)
...
| 8 | Operator/admin **UI** guides published | **E12.3** — stub: [operations/index.md](../operations/index.md) |
...
(feature stays disabled). 8–9 are slice of; keep the issue
open until she lands.

## Ownership

- this review, API/OpenAPI, deploy/ops runbooks.
- operator/admin UI guides + accessibility review. No UI
