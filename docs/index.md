...
- [First-run bootstrap gate](architecture/flowforge-first-run-bootstrap.md): B.1 server `GET /api/v1/bootstrap` + contract map for B.2–B.6. Standalone wizard only — never `/embed/v1`.
