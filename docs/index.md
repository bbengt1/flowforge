...
- [First-run bootstrap gate](architecture/flowforge-first-run-bootstrap.md): B.1 `GET /api/v1/bootstrap` + B.2 `POST /api/v1/bootstrap/persistence` + contract map for B.3–B.6. Standalone wizard only — never `/embed/v1`.
