...
> Internal issue-creation backlog. Not product documentation. The product scope page is [../master-implementation-plan.md](../master-implementation-plan.md). This copy keeps GitHub issue links and ownership for planning.
