...
start_local_stack() {
  ...
  export JOB_BINDING_SECRET="${JOB_BINDING_SECRET:-Zmxvd2ZvcmdlLWxvY2FsLWRldi1qb2ItMzJieXRlcyE=}"
  export SCRIPT_SIGNING_KEY="${SCRIPT_SIGNING_KEY:-Zmxvd2ZvcmdlLWxvY2FsLWRldi1zY3ItMzJieXRlcyE=}"
...
SQL
  ...
  (
    ...
    env DATABASE_URL="$DATABASE_URL" \
      ...
      JOB_BINDING_SECRET="$JOB_BINDING_SECRET" \
      SCRIPT_SIGNING_KEY="$SCRIPT_SIGNING_KEY" \
