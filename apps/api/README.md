...
| `SCHEDULER_ENABLED` | on | In-process leader ticks schedule dispatch, lease recovery, and retention purge. `0`/`false`/`no`/`off` opts out. Any other non-empty value is a boot-fail. Multi-replica safe (advisory lock `881726402`). |
