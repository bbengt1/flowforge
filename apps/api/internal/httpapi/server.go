...
func newServer(d Deps) *API {
	...
	mux.HandleFunc("GET /api/v1/workflow-folders", s.listWorkflowFolders)
	mux.HandleFunc("POST /api/v1/workflow-folders", s.createWorkflowFolder)
	mux.HandleFunc("GET /api/v1/workflow-folders/{folderId}", s.getWorkflowFolder)
	mux.HandleFunc("PATCH /api/v1/workflow-folders/{folderId}", s.updateWorkflowFolder)
	mux.HandleFunc("DELETE /api/v1/workflow-folders/{folderId}", s.deleteWorkflowFolder)
	...
	mux.HandleFunc("PATCH /api/v1/workflows/{workflowId}/folder", s.patchWorkflowFolder)
