...
func adapterAPI() []APIRoute {
	return []APIRoute{
		...
		{Method: "POST", Path: "/api/v1/embed/exchange", Auth: "assertion", CSRF: "no", Note: "E11.1/E11.2 exchange. Not a Portal-specific path. Replay 409. Binds (tenant_id, workbench_key) onto CHIPS cookies (SameSite=None; Secure; Partitioned). Bound sessions cannot create tenants or sibling workbenches. Cookie not sent is 401/403."},
