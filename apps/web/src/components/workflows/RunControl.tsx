    ...
    >
        ...
        <div className="mt-4 space-y-3">
          ...
          >
            ...
            <dl className="mt-3 grid gap-2 text-sm sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <dt className="text-muted-foreground">Trigger input (redacted)</dt>
                <dd>
                  <pre className="mt-1 overflow-auto rounded-lg bg-card p-2 font-mono text-xs text-foreground">
            ...
            {!review.published ? (
              <p className="mt-3 text-sm text-warning-foreground">{review.blockReason}</p>
            ) : null}
          </section>
          <PreRunPolicyReview
      ...
      {execution ? (
        <div className="mt-4 space-y-2 rounded-lg bg-background px-3 py-3 text-sm">
          ...
          <div className="pt-1">
            <p className="text-xs font-medium text-muted-foreground">Config pins</p>
            <ConfigPinList
              pins={execution.pins}
          ...
          {replayed ? (
            <p className="text-sm text-foreground">{IDEMPOTENCY_REPLAY_MESSAGE}</p>
          ) : created ? (
            <p className="text-sm text-foreground">{IDEMPOTENCY_CREATED_MESSAGE}</p>
          ) : null}
          <div className="pt-2">
