    ...
    >
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
        <label className="block text-sm">
          <span className="text-muted-foreground">Compare left</span>
          <select
            value={compareLeft}
        ...
        <label className="block text-sm">
          <span className="text-muted-foreground">Compare right</span>
          <select
            value={compareRight}
      ...
      {compare ? (
        <div className="mt-4 space-y-2 text-sm">
          ...
          {compare.changes.length === 0 ? (
            <p className="text-muted-foreground">No structured changes.</p>
          ) : (
