  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-xs text-zinc-500">
        {fromCatalog
          ? "Ports, policy, and bounds come from GET /workflows/catalog. Kubernetes read/apply prefer GET /kubernetes/catalog nodes[] / errors[] / apply (#78) when listed. ssh.run prefers GET /ssh/catalog nodes[] , otherwise the marked E8.2 contract fallback."
          : "Showing the published core-neutral, Kubernetes read/apply, and ssh.run contract fallback until GET /workflows/catalog, GET /kubernetes/catalog, and GET /ssh/catalog load."}
      </p>
