...
export function RuntimeProfileForm({
  ...
  return (
    <div className="grid gap-4">
      ...
      <fieldset className="grid gap-3 rounded-xl border border-border px-4 py-3 sm:grid-cols-2">
      ...
      {showEgress ? (
        <fieldset className="grid gap-3 rounded-xl border border-border px-4 py-3">
          ...
          {destinations.map((row, index) => (
            ...
            >
              ...
              <button
                ...
                className="self-end rounded-lg border border-border px-3 py-2 text-sm disabled:opacity-60"
              >
                Remove
              </button>
          ...
          <button
            ...
            className="w-fit rounded-lg border border-border px-3 py-1.5 text-sm disabled:opacity-60"
          >
            Add destination
          </button>
        </fieldset>
