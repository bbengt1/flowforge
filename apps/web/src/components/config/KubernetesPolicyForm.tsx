  ...
  return (
    <div className="grid gap-4">
      ...
      <fieldset className="text-sm">
        ...
        <p className="mt-1 text-xs text-fg">{KUBERNETES_KIND_HELP}</p>
      ...
      <fieldset className="text-sm">
        ...
        <p className="mt-1 text-xs text-fg">{KUBERNETES_VERB_HELP}</p>
      ...
      <fieldset className="text-sm">
        ...
        <p className="mt-1 text-xs text-fg">{KUBERNETES_APPROVAL_HELP}</p>
      ...
      {gaps.length > 0 ? (
        <ul className="space-y-1 text-sm text-fg" role="status">
          {gaps.map((gap) => (
            <li key={gap}>{gap}</li>
          ))}
        </ul>
