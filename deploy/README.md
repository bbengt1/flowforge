...
| Path | Role |
| --- | --- |
| [`k8s/`](k8s/) | Namespace, API/web/runner Deployments, encrypted backup CronJob, default-deny NetworkPolicy, TLS Ingress |
...
| [`supply-chain/`](supply-chain/) | Approved bases (`name:tag`; Dockerfiles must pin `@sha256:`) and vulnerability/provenance policy implemented in CI |
